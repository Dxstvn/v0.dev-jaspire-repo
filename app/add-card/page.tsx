...
import { ConnectDebug } from "@/components/mastercard/connect-debug"
    ...
    <AppShell>
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-md mx-auto">
        ...
        <motion.div variants={itemVariants}>
          ...
          <Card className="bg-secondary/50 border-0">
            <CardContent className="pt-6">
              <div className="space-y-6">
                ...
                <ConnectButton className="w-full bg-white text-black hover:bg-white/90" />
          ...
          {process.env.NODE_ENV === "development" && <ConnectDebug />}
        </motion.div>
      </motion.div>
    </AppShell>
  )
